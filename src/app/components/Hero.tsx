...
const Hero = React.forwardRef<HTMLElement, { id: string }>(({ id }, ref) => {
 ...
 leading-14 px-4 sm:leading-18 w-[96%] sm:max-w-2xl md:max-w-[44rem]"
      >
        Crafting Modern Web Experiences for{" "}
        <span className="italic">Tomorrow</span>{" "}
      </motion.h1>
      ...
      >
        Welcome, I&apos;m Pratik Srivastava, a Full Stack Developer{" "}
      </motion.p>
      <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      >
        <motion.a
          ...
          whileHover="hover"
          href="https://www.linkedin.com/in/pratik-srivastava-85000026b"
          target="_blank"
